...
plt.ylabel(r'$\displaystyle T(t) \; [cells/\mu l]$', labelpad=label_pad_x, fontsize=fontsize_labels)
...
plt.xlim((0, t_end))
plt.xlabel(r'$\displaystyle time \; [days]$', labelpad=label_pad_y, fontsize=fontsize_labels)
plt.ylabel(r'$\displaystyle T_s(t) \; [log_{10}(cells/ml^3)]$', labelpad=label_pad_x, fontsize=fontsize_labels)
plt.tick_params(labelsize=16)
plt.tight_layout()
...
plt.xlim((0, t_end))
plt.xlabel(r'$\displaystyle time \; [days]$', labelpad=label_pad_y, fontsize=fontsize_labels)
plt.ylabel(r'$\displaystyle V_s(t) \; [log_{10}(cells/ml^3)]$', labelpad=label_pad_x, fontsize=fontsize_labels)
plt.tick_params(labelsize=16)
plt.tight_layout()
...
# plt.legend()
plt.xlabel(r'$\displaystyle time \; [days]$', labelpad=label_pad_y, fontsize=fontsize_labels)
plt.ylabel(r'$\displaystyle T_r(t) \; [log_{10}(cells/ml^3)]$', labelpad=label_pad_x, fontsize=fontsize_labels)
plt.tight_layout()
plt.tick_params(labelsize=16)
...
# plt.ylim((-15, 5))
plt.xlabel(r'$\displaystyle time \; [days]$', labelpad=label_pad_y, fontsize=fontsize_labels)
plt.ylabel(r'$\displaystyle V_r(t) \; [log_{10}(cells/ml^3)]$', labelpad=label_pad_x, fontsize=fontsize_labels)
plt.tick_params(labelsize=16)
plt.tight_layout()
...
# plt.ylim((-10, 10))
plt.xlabel(r'$\displaystyle time \; [days]$', labelpad=label_pad_y, fontsize=fontsize_labels)
plt.ylabel(r'$\displaystyle V_r(t) + V_s(t) \; [log_{10}(cells/ml^3)]$', labelpad=label_pad_x, fontsize=fontsize_labels)
plt.tick_params(labelsize=16)
plt.tight_layout()
...
plt.xlim((0, t_end))
plt.xlabel(r'$\displaystyle time \; [days]$', labelpad=label_pad_y, fontsize=fontsize_labels)
plt.ylabel(r'viral cell concentration $\displaystyle[log_{10}(cells/ml^3)]$', labelpad=label_pad_x, fontsize=fontsize_labels)
plt.tick_params(labelsize=16)
plt.tight_layout()
...
# plt.ylim((-10, 10))
plt.xlabel(r'$\displaystyle time \; [days]$', labelpad=label_pad_y, fontsize = fontsize_labels)
plt.ylabel(r'immune cell concentration $\displaystyle[log_{10}(cells/ml^3)]$', labelpad=label_pad_x, fontsize=fontsize_labels)
plt.tick_params(labelsize=16)
plt.tight_layout()
